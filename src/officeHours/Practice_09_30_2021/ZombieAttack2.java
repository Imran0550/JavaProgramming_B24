package officeHours.Practice_09_30_2021;
        ...
        3 conditions/actions
           ...
           if you 0 in the beginning
                ...
                if you are in the middle anywhere
                  ...
                  when to stop?
                    when all cities population are 0
         */
            ...
            for(int i =0; i < inhabitants.length;i++){
                ...
                if(inhabitants[i] == 0){
                    ...
                    if(i  == 0 ){
                        ...
                        // we found 0 somewhere in the middle
